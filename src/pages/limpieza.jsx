  ...
  return (
    ...
    >
      <div className="plan-limpieza-cabecera">
        ...
        <a className="boton-control enlace-plan-pdf" href={`${import.meta.env.BASE_URL}documentos/pla_neteja_cusachs_registre_setmanal.pdf`} target="_blank" rel="noreferrer" download>📄 Descargar plan completo en PDF</a>
      </div>
