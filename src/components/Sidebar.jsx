  ...
  return (
    <aside className="sidebar">
      ...
      <div className="menu-section">
        ...
        <NavLink to="/catalogo-proveedores" className={claseEnlace}>
          📚 Catálogo proveedores
        </NavLink>
        <NavLink to="/comparador-precios" className={claseEnlace}>
          💶 Comparador precios
        </NavLink>
        <NavLink to="/compras" className={claseEnlace}>
          🛒 Compras
        </NavLink>
        <NavLink to="/importar-albaranes" className={claseEnlace}>
          📄 Importar albaranes
        </NavLink>
      </div>
