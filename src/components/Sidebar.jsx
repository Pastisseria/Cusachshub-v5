...
function Sidebar({ abierto = false, onCerrar }) {
  ...
  function mostrarListadoPresupuestos() {
    window.dispatchEvent(
      new CustomEvent("cusachs:mostrar-listado-presupuestos"),
    );
  }
    ...
    return (
      ...
      >
        ...
        <div className="menu-section">
          <h4>ESPACIOS</h4>
          <NavLink to="/espacios" className={claseEnlace}>
            ← Cambiar de espacio
          </NavLink>
        </div>
        <div className="menu-section">
          ...
          <NavLink to="/higiene/control-recepcion" className={claseEnlace}>✅ Control recepción</NavLink>
          ...
          <NavLink to="/higiene/personal-riesgos" className={claseEnlace}>🦺 Personal y riesgos laborales</NavLink>
        </div>
        <div className="menu-section">
        ...
        <div className="menu-section">
          ...
          <NavLink to="/higiene/catalogo-proveedores" className={claseEnlace}>
            📚 Catálogo proveedores
          </NavLink>
          <NavLink to="/higiene/comparador-precios" className={claseEnlace}>
            💶 Comparador de precios
          </NavLink>
          <NavLink to="/higiene/compras" className={claseEnlace}>
            🛒 Compras
          </NavLink>
          <NavLink
            to="/higiene/importador-albaranes-v3"
            className={claseEnlace}
          >
            🧠 Importar albaranes
          </NavLink>
          <NavLink to="/higiene/albaranes" className={claseEnlace}>
  ...
  return (
    ...
    >
      <div className="logo">
        <h2>CUSACHS HUB</h2>
        <button type="button" className="cerrar-menu-tablet" onClick={onCerrar}>
          ×
        </button>
      </div>
      <div className="menu-section">
        <h4>INICIO</h4>
        <NavLink
          to={esAdministrador ? "/espacios" : "/catering"}
          className={claseEnlace}
        >
          🏠 Inicio
        </NavLink>
      ...
      <div className="menu-section">
        ...
        <NavLink to="/presupuestos-estandar" className={claseEnlace}>
      ...
      {esAdministrador && (
        <>
          ...
          <div className="menu-section">
            ...
            <NavLink to="/importar-emails" className={claseEnlace}>
              📥 Importar emails
            </NavLink>
            <NavLink to="/facturacion" className={claseEnlace}>
              🧾 Datos para la factura
            </NavLink>
            <NavLink to="/estadisticas" className={claseEnlace}>
              📈 Estadísticas
            </NavLink>
            <NavLink to="/configuracion" className={claseEnlace}>
              ⚙ Configuración
            </NavLink>
          </div>
        </>
